...
# this below is called nexted route
# localhost:8000/accounts/1(accountNumber)/transactions/1
...
SECRET_KEY = 'django-insecure-0ic&s1a-bzsc^c@pa60led*^i2$r5b%c++f^)0e2^$@*^f(-n@'
...
EMAIL_HOST_PASSWORD = ''
EMAIL_PORT = 2525
DEFAULT_FROM_EMAIL = 'info@agudabank'
